...
线性后端还支持 `gmres ilut`、`gmres amg`、`cg amg`、`bicgstab amg` 和独立的 `amg none`。例如：
...
vectorSolver gmres amg 1e-12 1e-8 800 gmresRestart=30 amgMaxLevels=12 amgCoarseSize=48 amgSmoothingSteps=2 amgRefreshInterval=4
```
