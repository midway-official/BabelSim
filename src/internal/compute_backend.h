...
public:
    ...
    virtual SolveResult solve(const ScalarDiscreteEquation&, ScalarField&, const LinearSolverConfig&) = 0;
    virtual std::array<SolveResult,3> solve(const VectorDiscreteEquation&, VectorField&, const LinearSolverConfig&) = 0;
